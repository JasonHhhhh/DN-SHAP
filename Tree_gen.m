load('D:\working\Matlab_prjs\Gas_Line_case\src\SHAPtree_data_0126_1000.mat');
load('D:\working\Matlab_prjs\Gas_Line_case\src\SHAPtree_data_base.mat');
% 数据准备
...
label_2468={label2,label4,label6,label8};
% 24个决策树 先看cost
for iiii=1:4
