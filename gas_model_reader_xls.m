function [network]=gas_model_reader_xls(par)
...
[node_data,node_text]=xlsread([mfolder '\input_network_nodes']);
[pipe_data,pipe_text]=xlsread([mfolder '\input_network_pipes']);
[comp_data,comp_text]=xlsread([mfolder '\input_network_comps']);
[gnode_data,gnode_text]=xlsread([mfolder '\input_network_gnodes']);
...
fid = fopen([mfolder '\input_network.txt'],'wt');
